...
"
" Custom cterm colors added to this version by Max Goldstein
...
if has("gui_running")
    ...
    exec "hi LineNr         cterm=NONE   ctermfg=244" . " ctermbg=" . <SID>X(80)
    ...
    exec "hi String         cterm=NONE   ctermfg=148" . " ctermbg=NONE"
    exec "hi Character      cterm=NONE   ctermfg=148" . " ctermbg=NONE"
    exec "hi Error          cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(32)
    exec "hi Identifier     cterm=NONE   ctermfg=75" . " ctermbg=" . "NONE"
    exec "hi Parens         cterm=NONE   ctermfg=157" . " ctermbg=" . "NONE"
    exec "hi CurlyBraces    cterm=NONE   ctermfg=83" . " ctermbg=" . "NONE"
    exec "hi SqBrackets     cterm=NONE   ctermfg=159" . " ctermbg=" . "NONE"
    ...
    exec "hi Statement      cterm=NONE   ctermfg=105" . " ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(57)
    exec "hi Type           cterm=NONE   ctermfg=183" . " ctermbg=" . "NONE"
    ...
    if v:version >= 700
        ...
        exec "hi MatchParen     cterm=NONE ctermbg=NONE ctermfg=87"
    endif
    if v:version >= 703
